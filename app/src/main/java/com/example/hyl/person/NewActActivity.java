...
public class NewActActivity extends AppCompatActivity {
    ...
    private ImageButton addActBack,addActCheck;
    private EditText addActTitle,addActLoc,addActNotes;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_action_layout);
        Intent intent = getIntent();
        String selectDate = intent.getStringExtra("selectDate");
        userID = intent.getStringExtra("userID");
        notes[0]=selectDate;
        notes[2]=selectDate;
        addActBack = (ImageButton)findViewById(R.id.back);
        addActCheck = (ImageButton)findViewById(R.id.check);
        addActTitle = (EditText)findViewById(R.id.active_title);
        addActLoc = (EditText)findViewById(R.id.area);
        addActNotes = (EditText)findViewById(R.id.explain);
        ...
        showDetails();
        addActTitle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                addActTitle.selectAll();
            }
        });
        addActLoc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                addActLoc.selectAll();
            }
        });
        addActNotes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                addActNotes.selectAll();
            }
        });

        addActCheck.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String actTitle =addActTitle.getText().toString();
                String actLoc =addActLoc.getText().toString();
                String actNotes =addActNotes.getText().toString();
                if(actTitle.equals(""))
                    new AlertDialog.Builder(NewActActivity.this)
                    ...
                    String values = null;
                    try {
                        values = "values( '" + notes[0]+" "+notes[1] + "','" +notes[2]+" "+notes[3] + "','" + notes[4] + "','" +notes[5]+"','"+ userID+ "','" +actTitle+ "','" +actLoc+ "','"+actNotes+"','"+getBeforeTime( notes[0]+" "+notes[1],notes[5])+"','false')";
                    } catch (ParseException e) {
                        e.printStackTrace();
                    }
                    db.execSQL("insert into scheduletb(starttime,endtime,repeat,befores,userID,title,location,notes,beforetime,isClick) " + values);
                    AlarmListen();
                    Dialog progressDialog= new Dialog(NewActActivity.this,R.style.progress_dialog);
        ...
        addActBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                finish();
            }
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                switch (position){
                    case 0:{
                        ...
                        new DatePickerDialog(NewActActivity.this,
                                // 绑定监听器
                    ...
                    case 4:{
                        final AlertDialog.Builder builder = new AlertDialog.Builder(NewActActivity.this);
                        builder.setTitle("重复");
