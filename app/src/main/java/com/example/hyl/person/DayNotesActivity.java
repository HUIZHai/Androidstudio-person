...
public class DayNotesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sql = "select * from moneytb where time = '" + getTime()+"' and isDelete = 'false' and userID = "+userID;
        showNote(sql);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(DayNotesActivity.this, EditNotes.class);
